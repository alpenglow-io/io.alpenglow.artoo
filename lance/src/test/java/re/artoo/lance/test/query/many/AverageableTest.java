...
public class AverageableTest {
  ...
  public void shouldAverageDoubles() throws Throwable {
    final var averaged = Many.from(78.0, 92.0, 100.0, 37.0, 81.0).average().cursor().scroll();
  ...
  public void shouldBeNullSinceNoNumbers() throws Throwable {
    final var expected = Many.from("apple", "banana", "mango", "orange", "passionfruit", "grape").average().cursor().scroll();
