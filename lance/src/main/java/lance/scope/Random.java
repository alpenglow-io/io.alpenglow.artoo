...
import lance.scope.random.Binary;
import lance.scope.random.Decimal32;
import lance.scope.random.Decimal64;
import lance.scope.random.Gaussian;
import lance.scope.random.Int;
import lance.scope.random.Scramble;
