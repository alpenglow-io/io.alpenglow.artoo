...
public class SettableTest {
  ...
  public void shouldDistinctRecords() {
    final var distinct = Many.from(new re.artoo.lance.test.Test.Pet("Pluto", 1), new re.artoo.lance.test.Test.Pet("Fuffy", 2), new re.artoo.lance.test.Test.Pet("Fuffy", 2)).distinct();

    assertThat(distinct).containsExactly(new re.artoo.lance.test.Test.Pet("Pluto", 1), new re.artoo.lance.test.Test.Pet("Fuffy", 2));
  }

  @Test
  @DisplayName("should distinct repeated records")
  public void shouldDistinctRecordss() {
    final var distinct = Many.from(new re.artoo.lance.test.Test.Pet("Pluto", 1), new re.artoo.lance.test.Test.Pet("Fuffy", 2), new re.artoo.lance.test.Test.Pet("Fuffy", 2), new re.artoo.lance.test.Test.Pet("Toffy", 3)).distinct();

    assertThat(distinct).containsExactly(new re.artoo.lance.test.Test.Pet("Pluto", 1), new re.artoo.lance.test.Test.Pet("Fuffy", 2), new re.artoo.lance.test.Test.Pet("Toffy", 3));
  }
  ...
  public void shouldDistinctRecordsWithCondition() {
    final var distinct = Many.from(
      new re.artoo.lance.test.Test.Pet("Pluto", 1),
      new re.artoo.lance.test.Test.Pet("Goofy", 1),
      new re.artoo.lance.test.Test.Pet("Pluto", 1),
      new re.artoo.lance.test.Test.Pet("Fuffy", 2),
      new re.artoo.lance.test.Test.Pet("Zeus", 2),
      new re.artoo.lance.test.Test.Pet("Hermes", 2),
      new re.artoo.lance.test.Test.Pet("Hermes", 2),
      new re.artoo.lance.test.Test.Pet("Heracles", 2),
      new re.artoo.lance.test.Test.Pet("Cerberos", 3),
      new re.artoo.lance.test.Test.Pet("Bart", 4),
      new re.artoo.lance.test.Test.Pet("Homer", 4)
