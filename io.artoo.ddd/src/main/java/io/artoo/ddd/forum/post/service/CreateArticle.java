...
public interface CreateArticle extends Service.Operation<CreateArticle.Action> {
  record Action(Post.Title title, Post.Text text) implements Domain.Act {}
  ...
  final class Transactional implements CreateArticle {
    ...
    @Override
    public Void tryApply(Id id, Action action) throws Throwable {
