...
public record Single32(float eval) implements Numeric<Single32> {
  ...
  @Contract("_ -> new")
  @Override
  public <V extends Record & Numeric<V>> @NotNull Single32 add(@NotNull V value) {
    return new Single32(eval + value.raw().floatValue());
  }

  @Contract("_ -> new")
  @Override
  public <V extends Record & Numeric<V>> @NotNull Single32 div(@NotNull V value) {
    return new Single32(eval / value.raw().floatValue());
  }
