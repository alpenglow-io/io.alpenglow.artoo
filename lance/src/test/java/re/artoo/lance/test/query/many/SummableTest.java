...
public class SummableTest {
  ...
  public void shouldSumFloatSequence() throws Throwable {
    final var sum = Many.from(43.68F, 1.25F, 583.7F, 6.5F).sum().cursor().scroll();
  ...
  public void shouldSumNullableFloatSequence() throws Throwable {
    final var sum = Many.fromAny(null, "0", 92.83F, null, 100.0F, 37.46F, 81.1F).sum().cursor().scroll();
  ...
  public void shouldSumDoubleSequence() throws Throwable {
    final var sum = from(43.68D, 1.25D, 583.7D, 6.5D).sum().cursor().scroll();
  ...
  public void shouldSumNullableDoubleSequence() throws Throwable {
    final var sum = Many.fromAny(null, 0, 92.83D, null, 100.0D, 37.46D, 81.1D).sum().cursor().scroll();
  ...
  public void shouldSumBySelecting() throws Throwable {
    final var sum = Many.from(PACKAGES).sum(re.artoo.lance.test.Test.Package::weight).cursor().scroll();
  ...
  public void shouldSumWithGenericSpecified() throws Throwable {
    final var sum = Many.fromAny(25.2f, "Coho Vineyard", "Lucerne Publishing", BigInteger.valueOf(12)).sum().cursor().scroll();
  ...
  public void shouldSumIgnoringNull() throws Throwable {
    final var sum = Many.fromAny(null, "Coho Vineyard", "Lucerne Publishing", 12L).sum().cursor().scroll();
  ...
  public void shouldFailIfNoNumbers() throws Throwable {
    final var sum = Many.from("Coho Vineyard", "Wingtip Toys", "Adventure Works").sum().cursor().scroll();
