...
public interface Projectable3<V1, V2, V3> extends Queryable3<V1, V2, V3> {
  ...
  default Queryable3<V1, V2, V3> peek2(final Con<? super V1, ? super V2, ? super V3> peek) {
    return new Peek3<>(this, Nullability.nonNullable(peek, "peek"));
  }
}
...
final class Peek3<V1, V2, V3> implements Queryable3<V1, V2, V3> {
  private final Queryable<Tuple3<V1, V2, V3>> queryable;
  private final Con<? super V1, ? super V2, ? super V3> peek;

  @Contract(pure = true)
  Peek3(Queryable<Tuple3<V1, V2, V3>> queryable, Con<? super V1, ? super V2, ? super V3> peek) {
    this.queryable = queryable;
    this.peek = peek;
  }
