...
@FunctionalInterface
public interface Consumer6<T1, T2, T3, T4, T5, T6> extends Functional.Con {
  void accept(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6);

  default Consumer6<T1, T2, T3, T4, T5, T6> then(Consumer6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6> after) {
