...
sealed public interface Scramble extends One<Scramble.Seed> {
  ...
  <R> R apply(TryTriFunction<? super AtomicLong, ? super Long, ? super Long, ? extends R> func);
  ...
  final class Initial implements Scramble {
    ...
    @Override
    public <R> R apply(final TryTriFunction<? super AtomicLong, ? super Long, ? super Long, ? extends R> func) {
