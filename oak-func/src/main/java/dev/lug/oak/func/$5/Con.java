...
@FunctionalInterface
public interface Con<T1, T2, T3, T4, T5> extends Functional.Con {
  void accept(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5);

  default Con<T1, T2, T3, T4, T5> then(Con<? super T1, ? super T2, ? super T3, ? super T4, ? super T5> after) {
