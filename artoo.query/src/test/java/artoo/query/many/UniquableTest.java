...
class UniquableTest {
  ...
  void shouldGetFirstOrDefaultIfNone() {
    ...
    for (final var value : from(numbers).first())
  ...
  void shouldGetFirstEvenNumberOrDefaultIfNone() {
    ...
    for (final var value : from(numbers).first(number -> number % 2 == 0))
      assertThat(value).isEqualTo(34);
    for (final var value : from(odds).first(number -> number % 2 == 0).or(-1))
      assertThat(value).isEqualTo(-1);
  }
  ...
  void shouldGetLastOrDefaultIfNone() {
    ...
    for (final var value : from(numbers).last())
  ...
  void shouldGetLastEvenNumberOrDefaultIfNone() {
    ...
    for (final var value : from(numbers).last(number -> number % 2 == 0))
      assertThat(value).isEqualTo(12);
    for (final var value : from(odds).last(number -> number % 2 == 0).or(-1))
      assertThat(value).isEqualTo(-1);
  }
  ...
  void shouldGetSingle() {
    ...
    for (final var value : from(numbers).single())
      assertThat(value).isEqualTo(9);
    for (final var value : from(evens).single(number -> number % 2 == 0))
      assertThat(value).isEqualTo(34);
  }
  ...
  void shouldFailIfThereIsMoreThanSingleElement() {
    ...
    assertThat(from(numbers).single()).isEmpty();
    assertThat(from(numbers).single(number -> number < 20)).isEmpty();
  }
  ...
  void shouldGetNegativeNumberSinceItFails() {
    ...
    for (final var value : from(numbers).single().or(-1))
      assertThat(value).isEqualTo(-1);
    for (final var value : from(numbers).single(number -> number < 20).or(-1))
      assertThat(value).isEqualTo(-1);
  }
}
