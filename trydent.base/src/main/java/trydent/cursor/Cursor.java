...
import static trydent.type.Nullability.nullable;
...
public interface Cursor<E> extends Iterator<E> {
  ...
  @NotNull
  @Contract(pure = true)
  static <V1, V2> trydent.cursor.$2.Cursor<V1, V2> of(final V1 value1, final V2 value2) {
    return nullable(value1, value2, trydent.cursor.$2.Cursor::one, trydent.cursor.$2.Cursor::none) ;
  }
}
