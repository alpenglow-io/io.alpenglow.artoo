...
public interface Nullability {
  ...
  static <T1, T2, R> R nullable(final T1 value1, final T2 value2, final trydent.func.$2.Func<T1, T2, R> then, final Suppl<R> otherwise) {
    return value1 == null && value2 == null
      ? nonNullable(otherwise, "otherwise").get()
      : nonNullable(then, "then").apply(value1, value2);
  }

  static <T1, T2, T3, R> R nullable(final T1 value1, final T2 value2, final T3 value3, final trydent.func.$3.Func<T1, T2, T3, R> then, final Suppl<R> otherwise) {
