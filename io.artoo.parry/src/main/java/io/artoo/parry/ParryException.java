 ...
 *
 */
public class ParryException extends RuntimeException {
   ...
   */
  public ParryException(String message) {
    super(message);
  }
   ...
   */
  public ParryException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @param cause  the cause
   */
  public ParryException(Throwable cause) {
    super(cause);
  }
   ...
   */
  public ParryException(String message, boolean noStackTrace) {
   ...
   * @param noStackTrace  disable stack trace capture
   */
  public ParryException(String message, Throwable cause, boolean noStackTrace) {
   ...
   * @param noStackTrace  disable stack trace capture
   */
  public ParryException(Throwable cause, boolean noStackTrace) {
