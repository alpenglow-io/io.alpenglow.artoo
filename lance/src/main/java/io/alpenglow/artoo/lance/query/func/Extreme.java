...
public final class Extreme<T, R extends Number, V> extends Tailrec<T, V, Extreme<T, R, V>> {
  ...
  private final TryFunction<? super T, ? extends R> selector;

  private Extreme(final V extreme, final Type type, final TryFunction<? super T, ? extends R> selector) {
  ...
  public static <T, R extends Number, V> Extreme<T, R, V> max(TryFunction<? super T, ? extends R> selector) {
  ...
  public static <T, R extends Number, V> Extreme<T, R, V> min(TryFunction<? super T, ? extends R> selector) {
