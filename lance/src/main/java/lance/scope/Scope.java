...
public abstract class Scope<T, $this extends Scope<T, $this>> implements One<T>, Suppl.MaybeSupplier<T> {
  ...
  public final <R, $new extends Scope<R, $new>> $new let(final Func.TryFunction<? super T, ? extends $new> let) {
    return let.apply(get());
  }

  @SuppressWarnings("unchecked")
  public $this apply(final Cons.TryConsumer<Scope<T, $this>> apply) {
