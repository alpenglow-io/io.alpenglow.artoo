package artoo.query.$2.many;

import artoo.union.$2.Union;

public interface Projectable<V1, V2> extends artoo.query.many.Projectable<Union<V1, V2>> {
/*
  default <R> trydent.query.Many select(final Tuple2AsAny<? super V1, ? super V2, ? extends R> map) {
...
final class Select2AsAny<V1, V2, R> implements trydent.query.Many {
  private final trydent.query.$2.Queryable<V1, V2> queryable;
  private final Func<? super V1, ? super V2, ? extends R> map;

  @Contract(pure = true)
  Select2AsAny(final trydent.query.$2.Queryable<V1, V2> queryable, final Func<? super V1, ? super V2, ? extends R> map) {
...
final class SelectAs<V1, V2, T1, T2, T extends Projectable<V1, V2> & Filterable<V1, V2> & Peekable2<V1, V2>> implements Many<T1, T2> {
  ...
  @Contract(pure = true)
  SelectAs(final trydent.query.$2.Queryable<V1, V2> queryable, final Func<? super V1, ? super V2, ? extends T> map) {
    this.queryable = queryable;
    this.map = map;
  }
...
final class Selection<V1, V2, T1, T2, T extends Projectable<V1, V2> & Filterable<V1, V2> & Peekable2<V1, V2>, S extends trydent.query.Queryable> implements Many<T1, T2> {
  private final trydent.query.Queryable queryable;
  private final Func<? super V1, ? super V2, ? extends S> flatMap;

  @Contract(pure = true)
  Selection(trydent.query.Queryable queryable, Func<? super V1, ? super V2, ? extends S> flatMap) {
    this.queryable = queryable;
...
final class Peek<V1, V2> implements Many<V1, V2> {
  ...
  @Contract(pure = true)
  Peek(trydent.query.Queryable queryable, Cons<? super V1, ? super V2> peek) {
    this.queryable = queryable;
    this.peek = peek;
  }
