...
import io.artoo.parry.eventbus.ConcurrentCyclicSequence;
import io.artoo.parry.eventbus.DeliveryContext;
...
public class EventBusImpl implements EventBusInternal {
  ...
  public EventBus send(String address, Object message, DeliveryOptions options) {
    var msg = createMessage(true, address, options.getHeaders(), message, options.getCodecName());
  ...
  public MessageImpl createMessage(boolean send, String address, Map<String, String> headers, Object body, String codecName) {
