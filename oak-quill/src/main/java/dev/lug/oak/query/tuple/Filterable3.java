...
final class Where3<V1, V2, V3> implements Queryable3<V1, V2, V3> {
  ...
  @Contract(pure = true)
  Where3(final Queryable<Tuple3<V1, V2, V3>> queryable, final Predicate3<? super V1, ? super V2, ? super V3> filter) {
...
final class OfType3<V1, V2, V3, T1, T2, T3> implements Queryable3<T1, T2, T3> {
  ...
  @Contract(pure = true)
  private OfType3(final Queryable<Tuple3<V1, V2, V3>> queryable, final Predicate3<? super V1, ? super V2, ? super V3> areTypes) {
    this.queryable = queryable;
