...
public class UniquableTest {
  ...
  public void shouldGetElementAt4() throws Throwable {
    ...
    assertThat(Many.from(names).at(4).cursor().traverse()).isEqualTo("Ito, Shu");
  }

  @Test
  @DisplayName("should get first element")
  public void shouldGetFirst() throws Throwable {
    final var first = from(9, 34, 65, 92, 87, 435, 3, 54, 83, 23, 87, 435, 67, 12, 19).first().cursor().traverse();
