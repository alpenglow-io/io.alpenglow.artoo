...
import io.alpenglow.artoo.lance.tuple.record.OfOne;
import io.alpenglow.artoo.lance.tuple.record.OfTwo;

public interface Tuple {
  static <A> OfOne<A> of(final A first) { return new OfOne<>(first); }
  static <A, B> OfTwo<A, B> of(final A first, final B second) { return new OfTwo<>(first, second); }
