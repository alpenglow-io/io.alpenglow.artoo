...
public abstract class TypeParameterMatcher {
  ...
  public static TypeParameterMatcher get(Class<?> parameterType) {
    var getCache = InternalThreadLocalMap.get().typeParameterMatcherGetCache();
    var matcher = (TypeParameterMatcher)getCache.get(parameterType);
    if (matcher == null) {
  ...
  public static TypeParameterMatcher find(Object object, Class<?> parametrizedSuperclass, String typeParamName) {
    var findCache = InternalThreadLocalMap.get().typeParameterMatcherFindCache();
    var thisClass = object.getClass();
    ...
    var matcher = (TypeParameterMatcher)((Map)map).get(typeParamName);
    if (matcher == null) {
